...
void Level9::Init()
{
	...
	puzzle3 = OBJECT_FACTORY->CreateObject(Type::Puzzle, { -268.f, 160.f }, 120.f);
	//puzzle3->pipe->SetDirection(false, true, false, true, false, false);

	puzzle4 = OBJECT_FACTORY->CreateObject(Type::DirPuzzle, { 140.f, 160.f }, -120.f);
	...
	puzzle7 = OBJECT_FACTORY->CreateObject(Type::Puzzle, { 72.f, 40.f }, 60.f);
	//puzzle7->pipe->SetDirection(false, false, true, true, false, false);

	puzzle8 = OBJECT_FACTORY->CreateObject(Type::Puzzle, { -268.f, -80.f }, 180.f);

	puzzle9 = OBJECT_FACTORY->CreateObject(Type::DirPuzzle, { 4.0f, -80.f });
	puzzle9->pipe->SetDirection(false, false, false, true, false, true);

	puzzle10 = OBJECT_FACTORY->CreateObject(Type::DirPuzzle, { 140.f, -80.f }, -240.f);
	...
	puzzle14 = OBJECT_FACTORY->CreateObject(Type::Puzzle, { 276.f, 160.f }, -60);
	...
	puzzle17 = OBJECT_FACTORY->CreateObject(Type::DirPuzzle, { 208.f, -200.f }, -60.f);
	puzzle17->pipe->SetDirection(true, false, false, false, false, true);

	puzzle18 = OBJECT_FACTORY->CreateObject(Type::DirPuzzle, { -132.f, 160.f }, -60.f);
